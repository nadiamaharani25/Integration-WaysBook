  ...
  return (
    ...
    >
      ...
      <Container className={cssModule.AdminComplain}>
        <h3 className="py-3 mt-2">Customer Complain</h3>
        <Row>
          <Col className={cssModule.contactContainer} sm={3}>
            {contacts.map((item, index) => (
              ...
              >
                <Col sm={2}>
                  <img
                    src={item.profile?.avatar || avatarIcon}
                    alt=""
                  />
                </Col>
                <Col sm={10}>
          ...
          {contact ? (
              ...
              <Row sm={10} className={cssModule.chatBoxBody}>
                ...
                >
                  {messages.map((item, index) => (
                    <div key={index}>
                      <div
                        className={`d-flex py-1 ${item.idSender === state.user.id
                          ? "justify-content-end"
            ...
            <Col>
              <h3 style={{ textAlign: 'center' }}>Click customer to start message</h3>
            </Col>
          )}
        </Row>
      </Container>

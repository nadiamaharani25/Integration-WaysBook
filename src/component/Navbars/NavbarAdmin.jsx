          ...
          >
            <Nav className={cssModule.navRightSide}>
              <Nav.Item onClick={navTrx} className={cssModule.btnCart}>
                <VscChecklist size="2em" className="me-1" />
              </Nav.Item>
              ...
              <Dropdown>
                ...
                <Dropdown.Menu as={CustomMenu} className={cssModule.dropItem}>
                  <Dropdown.Item onClick={navAdd}>
                    <img src={bookGrey} alt="" style={{ width: "27px" }} />
                    <span>Add Book</span>
                  </Dropdown.Item>
                  <Dropdown.Item onClick={navComp}>
                    <img src={chatGrey} alt="" style={{ width: "27px" }} />
                    <span>Complain</span>
                  </Dropdown.Item>
                  <Dropdown.Divider />
                  <Dropdown.Item onClick={handleOuts}>
                    <img src={logRed} alt="" style={{ width: "27px" }} />
                    <span>Logout</span>
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
